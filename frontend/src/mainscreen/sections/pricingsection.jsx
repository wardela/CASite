  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-40 end-20 w-96 h-96 bg-[#0884a9]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-40 start-20 w-96 h-96 bg-[#0884a9]/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto relative z-10">
            ...
            >
              ...
              <div className="space-y-2">
                <p className="text-base text-body-color dark:text-dark-6">
                  ...
                  <span className="font-semibold text-[#0884a9]">{t("pricing.description.line1_highlight")}</span>{" "}
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <PricingCard
            ...
            durationLabel={t("pricing.plans.essential.duration")}
            oldPrice="20"
            price="10"
            currency={t("pricing.card.currency")}
            onChoose={(plan) => {
              setSelectedPlan(plan);
              setIsModalOpen(true);
            }}
            discount={t("pricing.plans.essential.discount")}
    ...
    >
      <div
        className={`group relative h-full overflow-hidden rounded-2xl bg-white dark:bg-dark-2 shadow-xl transition-all duration-500 hover:shadow-2xl ${
          highlight
            ? "border-2 border-[#0884a9] transform lg:scale-105 lg:-translate-y-4"
            : "border border-gray-100 dark:border-dark-3 hover:border-[#0884a9]/30"
        }`}
      >
        {/* Popular Badge */}
        {badge && (
          <div className="absolute top-0 start-1/2 -translate-x-1/2 z-20">
            <div className="relative">
              <div className="bg-gradient-to-r from-[#0884a9] to-[#066f8f] px-6 py-2 text-xs font-bold text-white rounded-b-xl shadow-lg">
                {badge}
              </div>
              <div className="absolute -bottom-1 start-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-l-transparent border-r-8 border-r-transparent border-t-8 border-t-[#066f8f]"></div>
            </div>
          </div>
        )}

        {/* Gradient overlay on hover */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0884a9]/0 to-[#0884a9]/0 group-hover:from-[#0884a9]/5 group-hover:to-transparent transition-all duration-500 pointer-events-none"></div>

        <div className={`p-8 ${badge ? "pt-12" : ""}`}>
          {/* Title & Subtitle */}
          <div className="mb-6">
            <h3 className="text-2xl font-bold text-dark dark:text-white mb-2 group-hover:text-[#0884a9] transition-colors duration-300">
              {title}
            </h3>
            ...
            {durationLabel && (
              <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-[#0884a9]/20 bg-[#0884a9]/10 px-3 py-1 text-xs font-semibold text-[#0884a9]">
                {durationLabel}
              </div>
            )}
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="flex items-center gap-2 mb-2">
              <span className="text-sm line-through text-gray-400 dark:text-gray-500" dir="ltr">
                {oldPrice} {currency}
              </span>
              {discount && (
                <span className="text-xs text-blue-600 dark:text-blue-400 font-semibold" dir="ltr">
                  {discount}
                </span>
              )}
            </div>
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-5xl font-bold text-dark dark:text-white" dir="ltr">
                {price}
              </span>
          ...
          <button
            ...
            className={`group/btn w-full rounded-full py-4 font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl ${
              highlight
                ? "bg-gradient-to-r from-[#0884a9] to-[#066f8f] text-white hover:shadow-[#0884a9]/30"
                : "bg-[#0884a9] text-white hover:bg-[#066f8f]"
            }`}
          >
        ...
        {/* Bottom accent line */}
        {highlight && (
          <div className="absolute bottom-0 start-0 end-0 h-1 bg-gradient-to-r from-[#0884a9] to-[#066f8f]"></div>
        )}
      </div>
    </div>
  );
