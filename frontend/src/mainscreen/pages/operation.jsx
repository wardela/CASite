...
import staffImg from "../../assets/operation/staff.png";
import usersImg from "../../assets/operation/users.png";
import storageImg from "../../assets/operation/storage.png";
  ...
  {t("operations.sections.staff.features", { returnObjects: true }).map(
    (feature, idx) => (
      ...
      >
        {/* Background decorative elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute bottom-20 -start-20 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl"></div>
        </div>
