...
const modules = [
  ...
  const socialLinks = [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/eyadeh_app?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 -left-20 w-96 h-96 bg-[#5fb875]/5 rounded-full blur-3xl"></div>
...
<div className="flex items-center gap-3">
  {socialLinks.map((social, index) => (
    <a
      ...
      className="group w-10 h-10 rounded-full bg-white dark:bg-dark-2 border-2 border-gray-200 dark:border-dark-3 hover:border-[#5fb875] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-white hover:bg-[#5fb875] transition-all duration-300 hover:scale-110"
      ...
      {social.icon}
            ...
            <div className="w-full sm:w-1/2 lg:w-2/12 mb-12 lg:mb-0">
              <div className="mb-6">
                ...
                <div className="mt-2 w-12 h-1 bg-gradient-to-r from-[#5fb875] to-[#4a9960] rounded-full"></div>
              </div>
                ...
                {navigationLinks.map((link, index) => (
                  <li key={index}>
                    <button
                      ...
                      className="group inline-flex items-center gap-2 text-base text-body-color dark:text-dark-6 hover:text-[#5fb875] transition-colors duration-300"
                    >
                      <svg
    ...
    <li key={index}>
      <button
        ...
        className="group flex items-start gap-2 text-left
                   ...
                   hover:text-[#5fb875] transition-colors duration-300"
      >
        <svg
          className="w-5 h-5 text-[#5fb875] flex-shrink-0 mt-0.5
           ...
           <div className="w-full sm:w-1/2 lg:w-3/12">
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    ...
                    className="group flex items-start gap-3 text-body-color dark:text-dark-6 hover:text-[#5fb875] transition-colors duration-300"
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#5fb875]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#5fb875]/20 transition-colors duration-300">
                      <svg
                        className="w-5 h-5 text-[#5fb875]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div>
                      ...
                      <div className="text-sm" dir="ltr">+962 7 9816 3375</div>
                    </div>
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm">info@eyadehapp.com</div>
                    </div>
                  </a>
                </li>
              </ul>
              ...
              <div className="mt-6">
                <button
                  ...
                  className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#5fb875] to-[#4a9960] px-6 py-3 text-sm font-bold text-white shadow-lg hover:shadow-xl hover:shadow-[#5fb875]/30 transition-all duration-300 hover:scale-105"
                >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4" >
            ...
            <div className="text-center md:text-left" dir="ltr">
              <p className="text-sm text-body-color dark:text-dark-6">
                © {currentYear}{" "}
                <a
                  href="https://innovationelements.org/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-semibold text-[#5fb875] hover:underline"
                >
                  Innovation Elements
                </a>
                . All rights reserved.
        ...
        <div className="mt-8 text-center">
           <button
            className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#5fb875]/10 hover:bg-[#5fb875] text-[#5fb875] hover:text-white transition-all duration-300 hover:scale-110 group"
            onClick={() => {
                window.scrollTo({
                top: 0,
                behavior: "smooth",
